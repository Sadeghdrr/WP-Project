...
--------
  ...
  Note: Scenarios 6.7 (Declare Suspects) and 6.8 (Sergeant Review) were
  removed as part of the case/suspect workflow decoupling. Suspect approval
  and warrant issuance now happen per-suspect via the suspects API.
"""
